...
import models.cross_attention.view_transforms
# import view_transforms

PermuteType = models.cross_attention.view_transforms.PermuteType
TransformFuncType = models.cross_attention.view_transforms.TransformFuncType
...
def get_permute_transform(view_src: PermuteType,
    ...
    def transform(x: torch.Tensor) -> torch.Tensor:
        x_view_0 = models.cross_attention.view_transforms.permutation_inverse_transforms[view_src](x)
        return models.cross_attention.view_transforms.permutation_transforms[view_dst](
            x_view_0).contiguous()
...
def permute_rand(
    ...
    num_permutes = len(models.cross_attention.view_transforms.permutation_transforms)
