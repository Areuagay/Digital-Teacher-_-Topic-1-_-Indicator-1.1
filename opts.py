...
def parse_opts():
    ...
    parser.add_argument('--multi_dataset', default='iemocap',type=str, help='mosei, mosi, iemocap, meld')
    parser.add_argument('--n_classes', default=8, type=int, help='Number of classes')
    
    parser.add_argument('--model', default='transmodal', type=str, help='multimodalcnn, oursmodule, mosei_mosi_module, transmodal')
    ...
    parser.add_argument('--learning_rate', default=0.004, type=float, help='Initial learning rate (divided by 10 while training by lr scheduler)')
    parser.add_argument('--lr_factor',default=0.5, type=float, help='learning decline rate')
    ...
    # parser.add_argument('--lr_steps', default=[30, 55, 65, 70, 90, 200], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
    ...
    parser.add_argument('--n_threads', default=12, type=int, help='Number of threads for multi-thread loading yuanlaishi 16')
    ...
    parser.add_argument('--fusion', default='ia', type=str, help='fusion type: lt | it | ia | iat |ita | itt')
