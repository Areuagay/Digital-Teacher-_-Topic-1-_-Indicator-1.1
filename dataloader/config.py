...
def get_args():
    ...
    # Tasks
    parser.add_argument('--dataset', type=str, default='iemocap', choices=['mosi','mosei', 'mos', 'moseld', 'moseldmp', 'iemocap', 'meld', 'emotionlines', 'laptops', 'restaurants'],
...
def get_config(dataset='iemocap', mode='train', batch_size=1):
